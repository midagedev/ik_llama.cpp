        ...
        case LLM_ARCH_GLM_DSA:
            {
                ...
                if (is_dsv4) {
                    ...
                    if (model.arch == LLM_ARCH_DEEPSEEK41) {
                        // Only a source carries a compressor, only an index key owner carries
                        // indexer.attn_k, and only an index source carries indexer.attn_q_b. Walk
                        // the layers once and record who reads from whom.
